...
class USCES_GOOGLE_RECAPTCHA {
	...
	public function save_data() {
		...
		if ( isset( $_POST['usces_google_recaptcha_option_update'] ) ) {
			...
			self::$opts['site_key']   = ( isset( $_POST['site_key'] ) ) ? wp_unslash( $_POST['site_key'] ) : '';
			self::$opts['secret_key'] = ( isset( $_POST['secret_key'] ) ) ? wp_unslash( $_POST['secret_key'] ) : '';
		...
		<form action="" method="post" name="option_form" id="google_recaptcha_form">
			<div class="postbox">
				<div class="postbox-header">
					<h2><span><?php esc_html_e( 'Google reCAPTCHA v3', 'usces' ); ?></span><?php wel_esc_script_e( $status ); ?></h2>
